...
const CreatePickListModal = ({ isOpen, onClose, onSave, isSaving, error }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!item.trim() || !category.trim() || !title.trim()) {
      setLocalError("URL, category, and title are required");
      return;
    }
    setLocalError("");
    onSave({
      ...
      <div className="w-full max-w-lg bg-white/90 backdrop-blur-xl border border-black/10 rounded-[32px] p-6 shadow-2xl overflow-hidden animate-[scaleUp_0.3s_ease-out] flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
          <div className="flex-1 overflow-y-auto pr-1 flex flex-col gap-5 hide-scrollbar mb-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe your saved picklist item..."
                rows="3"
          ...
          <div className="flex gap-3 mt-auto">
            ...
            <button
              type="submit"
              disabled={!item.trim() || !category.trim() || !title.trim() || isSaving}
...
export default CreatePickListModal;
